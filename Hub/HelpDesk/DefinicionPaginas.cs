...
public abstract class PaginasHD : System.Web.UI.Page
{
...
public abstract class AdminOnlyPage : PaginasHD
{
...
public abstract class AgentPage : PaginasHD
{

    // a donde pueda entrar los agentes pueden entrar los admins, pero no al revés
    protected override void OnInit(EventArgs e)
    {
        base.OnInit(e);
        ...
        if (!string.Equals(role, "admin", StringComparison.OrdinalIgnoreCase) &&
                !string.Equals(role, "agente", StringComparison.OrdinalIgnoreCase))
            {
            Response.Redirect("~/AccesoRestringido.aspx", false);
            Context.ApplicationInstance.CompleteRequest();
        }
...
public abstract class UsuarioOnlyPage : PaginasHD
{
    protected override void OnInit(EventArgs e)
    {
        base.OnInit(e);
